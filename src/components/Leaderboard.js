...
class Leaderboard extends Component {
    ...
    componentDidMount() {
        ...
        // })
        var json_data = require('../2020_match_scouts.json')
                ...
                <Table className='Leaderboard'>
                    <TableHead>
                        <TableRow>
                            ...
                            <CustomTableCell align='left'><span
                                class='LeaderboardHeaderText'>Scouter Name</span></CustomTableCell>
                            <CustomTableCell align='left'><span
                                class='LeaderboardHeaderText'>Number of Scouts</span></CustomTableCell>
                        </TableRow>
                    </TableHead>
                    <TableBody>
                        {this.state.rows}
